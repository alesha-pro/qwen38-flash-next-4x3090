...
class QwenGatedDeltaNetAttention(GatedDeltaNetAttention):
    ...
    def __init__(
        ...
        # device context.  This norm used to bypass that context by forcing
        # the platform CUDA device, creating a ~322 MiB context (and real CUDA
        # allocations) in the otherwise CPU-only offload process.  Honor meta
        # construction there; ordinary GPU workers retain the explicit device.
